...
<html lang="en">
  <head>
    ...
    <link href="style/sstyle.css" rel="stylesheet">
   ...
   <!--navbar creation -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="ridge5.jpg" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="images/doctor.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Next Patient To Room 6!!</h5>
          <p>Doctors all geared up from the moment you enter the hospital.</p>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h5>Save Time</h5>
          <p>Stay Organised, Save Time and Improve Effectiveness of Patient Healthcare Process.</p>
        </div>
      </div>
    </div>
    ...
    <div class= "container">
      ...
      <div class="col-md-3 text-center">
          ...
          <h3>Calender Coordination</h3>
           <p>Immediately notify the department,automatically updating the calenders. </p> 
        ...
        <h3>Save Time</h3>
         <p>Automate and customize appointment confirmations, reminders, follow-ups </p> 
        ...
        <div class="col-md-3 text-center">
          <div class="icon">
            ...
            <h3>Custom Intake Forms</h3>
             <p>Learn about new patients or<br> familiarize yourself with returning patients with custom intake forms.</p> 
